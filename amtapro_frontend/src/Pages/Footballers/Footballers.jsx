        ...
        <div className="bg-white text-green-800 p-6">
            ...
            <form action="" className="bg-green-100 border border-green-700 rounded-lg p-6 mb-8 sm:mr-30 sm:ml-30  shadow-md grid grid-cols-1 md:grid-cols-2 gap-4">
...

                {
                    filteredData.length === 1 || filteredData.length === 0
                        ? <h1 className='text-black font-bold'>{filteredData.length} footballer found</h1>
            ...
            <div className='flex overflow-x-scroll'>
                {filteredData.length === 0 ? (
                    <h2 className="text-center text-red-600 font-semibold">No such player was found</h2>
                ) : (
